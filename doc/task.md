...
- [ ] **チケット33**: 商品詳細ページ `/products/[id]` を実装
  - `GET /api/products/:id` で詳細表示
- [ ] **チケット34**: 管理者商品管理画面に編集/削除を追加
  - `PUT /api/products/:id`, `DELETE /api/products/:id`
- [ ] **チケット35**: 商品登録フォームでカテゴリ一覧選択を導入
  - `GET /api/categories` でプルダウン表示
  - category_id 数値直入力を廃止
- [ ] **チケット36**: 管理者カテゴリ管理画面 `/admin/categories` を実装
  - `GET/POST/PUT/DELETE /api/categories`

#### フェーズ3: 管理者向けユーザー運用（P2）
- [ ] **チケット37**: 管理者向けユーザーロール変更画面 `/admin/users` を実装
