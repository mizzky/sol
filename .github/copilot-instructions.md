...
## develop
各作業を以下のように定義する。
- 「ログ記録」と指示された場合、会話のサマリーを出力する。確認後問題がなければdoc/memo/yyyymmdd.mdに記載する
...
- 「作業終了」と指示された場合、当日のdoc/memo/yymmdd.mdを参照する。ファイルが有れば追記し、ない場合は作業サマリーを記載する。当日中の学習記録を作成しdoc/memo/yymmdd_learning.mdに記載する。
